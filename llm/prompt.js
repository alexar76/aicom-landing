...
- If the brief is mixed, too short to tell, or language is unclear, use ui_locale from the request JSON (the language of the generator UI — e.g. "en", "ru", "es", "fr", "zh"). Do NOT default to English unless ui_locale is "en".
